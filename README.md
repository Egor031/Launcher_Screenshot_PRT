...
<img width="966" height="633" alt="image" src="https://github.com/user-attachments/assets/3c0146cd-bacd-421d-b9ab-df3973f17420" />

## Быстрый старт (для пользователей)

1. Скачать релиз (zip) и распаковать
2. Запустить `Launcher_Screenshot.exe`
3. Выбрать:
